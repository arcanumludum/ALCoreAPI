...
public class GuiIngameNew extends GuiIngame
{
    ...
    public GuiIngameNew()
    {
        ...
        this.persistantChatGUI = new GuiNewChat(Minecraft.getMinecraft());
    }
    
    public void init()
    {
        // Initialize Modules
    	ALCore.instance.guiHandler.initModules();
    }
    ...
    {	
        ...
        // Draw Modules
        ALCore.instance.guiHandler.renderModules();
    ...
    public void updateTick()
    {
        ...
        {
        	// Update Modules
        	ALCore.instance.guiHandler.updateModules();
