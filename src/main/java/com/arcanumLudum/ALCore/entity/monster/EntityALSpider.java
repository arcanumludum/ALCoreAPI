package com.arcanumLudum.ALCore.entity.monster;
...
public class EntityALSpider extends EntityMob
{
    private static final String __OBFID = "CL_00001699";
    public double jumpHeight = 0.4000000059604645D;
    public double moveSpeed = 0.800000011920929D;

    public EntityALSpider(World p_i1743_1_)
    {
        super(p_i1743_1_);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
    {
        ...
        {
            p_110161_1_1 = new EntityALSpider.GroupData();
            ...
            {
                ((EntityALSpider.GroupData)p_110161_1_1).func_111104_a(this.worldObj.rand);
            }
        }

        if (p_110161_1_1 instanceof EntityALSpider.GroupData)
        {
            int i = ((EntityALSpider.GroupData)p_110161_1_1).field_111105_a;
