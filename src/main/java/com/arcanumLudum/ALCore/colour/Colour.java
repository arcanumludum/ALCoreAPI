...
public abstract class Colour
{
    ...
    public static final int[] colourCode = new int[] {1973019, 11743532, 3887386, 5320730, 2437522, 8073150, 2651799, 11250603, 4408131, 14188952, 4312372, 14602026, 6719955, 12801229, 15435844, 15790320};
    ...
    {
        return "0x" + Integer.toHexString(pack()).toUpperCase();
    }
