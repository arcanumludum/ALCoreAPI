...
public class EntityColoredFX extends EntityFX
{
    float initialParticleScale;
    private static final String __OBFID = "CL_00000900";

    public EntityColoredFX(World p_i1201_1_, ColourRGB colour, double p_i1201_2_, double p_i1201_4_, double p_i1201_6_, double p_i1201_8_, double p_i1201_10_, double p_i1201_12_)
    {
        this(p_i1201_1_, colour, p_i1201_2_, p_i1201_4_, p_i1201_6_, p_i1201_8_, p_i1201_10_, p_i1201_12_, 1.0F);
    }

    public EntityColoredFX(World p_i1202_1_, ColourRGB colour, double p_i1202_2_, double p_i1202_4_, double p_i1202_6_, double p_i1202_8_, double p_i1202_10_, double p_i1202_12_, float p_i1202_14_)
    {
        ...
        this.particleRed = colour.r;
        this.particleGreen = colour.g;
        this.particleBlue = colour.b;
