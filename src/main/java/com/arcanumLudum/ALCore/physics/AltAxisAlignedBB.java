...
public class AltAxisAlignedBB {
	 ...
	 * maxX, maxY, maxZ
	 */
	public static AltAxisAlignedBB getBoundingBox(double par0, double par2,
	...
	public AltAxisAlignedBB(double par1, double par3, double par5, double par7,
	 ...
	 * maxZ
	 */
	public AltAxisAlignedBB setBounds(double par1, double par3, double par5,
	...
	public AxisAlignedBB addCoord(double par1, double par3, double par5) {
		...
		return getAABBPool().getBoundingBox(var7, var9, var11, var13, var15,
				var17);
	}
	...
	public AxisAlignedBB func_111270_a(AltAxisAlignedBB par1AxisAlignedBB) {
		...
		return getAABBPool().getBoundingBox(var2, var4, var6, var8, var10,
				var12);
	}
	...
	public AxisAlignedBB getOffsetBoundingBox(double par1, double par3,
			double par5) {
		return getAABBPool().getBoundingBox(this.minX + par1, this.minY + par3,
				this.minZ + par5, this.maxX + par1, this.maxY + par3,
				this.maxZ + par5);
	}
	 ...
	 */
	public double calculateXOffset(AltAxisAlignedBB par1AxisAlignedBB,
			double par2) {
		if (par1AxisAlignedBB.maxY > this.minY
				&& par1AxisAlignedBB.minY < this.maxY) {
			if (par1AxisAlignedBB.maxZ > this.minZ
	 ...
	 * the calculated offset. Otherwise return the calculated offset.
	 */
	public double calculateYOffset(AltAxisAlignedBB par1AxisAlignedBB,
			double par2) {
		if (par1AxisAlignedBB.maxX > this.minX
	 ...
	 * the calculated offset. Otherwise return the calculated offset.
	 */
	public double calculateZOffset(AltAxisAlignedBB par1AxisAlignedBB,
			double par2) {
		if (par1AxisAlignedBB.maxX > this.minX
				&& par1AxisAlignedBB.minX < this.maxX) {
			if (par1AxisAlignedBB.maxY > this.minY
	...
	public boolean intersectsWith(AltAxisAlignedBB par1AxisAlignedBB) {
		return par1AxisAlignedBB.maxX > this.minX
				&& par1AxisAlignedBB.minX < this.maxX ? (par1AxisAlignedBB.maxY > this.minY
				&& par1AxisAlignedBB.minY < this.maxY ? par1AxisAlignedBB.maxZ > this.minZ
				&& par1AxisAlignedBB.minZ < this.maxZ
				: false)
				: false;
	}
	...
	public boolean isVecInside(Vec3 par1Vec3) {
		return par1Vec3.xCoord > this.minX && par1Vec3.xCoord < this.maxX ? (par1Vec3.yCoord > this.minY
				&& par1Vec3.yCoord < this.maxY ? par1Vec3.zCoord > this.minZ
				&& par1Vec3.zCoord < this.maxZ : false)
				: false;
	}
	...
	public AxisAlignedBB copy() {
		return getAABBPool().getBoundingBox(this.minX, this.minY, this.minZ,
