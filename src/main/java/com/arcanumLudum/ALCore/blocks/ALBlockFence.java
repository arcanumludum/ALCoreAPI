...
public class ALBlockFence extends BlockFence {
    private final String field_149827_a;
    private static final String __OBFID = "CL_00000242";

	public ALBlockFence(String p_i45406_1_, Material p_i45406_2_) {
        super(p_i45406_1_, p_i45406_2_);
        this.field_149827_a = p_i45406_1_;
	}
	
	public ALBlockFence(Material p_i45394_1_, String textureName, String blockName, SoundType type, CreativeTabs tab) {
        super(textureName, p_i45394_1_);
