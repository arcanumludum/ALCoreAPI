...
public class ALColourBlockLadder extends Block {
	private int meta;

	protected ALColourBlockLadder(int meta) {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess p_149719_1_,
		...
		this.func_149797_b(p_149719_1_.getBlockMetadata(p_149719_2_,
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool(World p_149633_1_,
		...
		this.setBlockBoundsBasedOnState(p_149633_1_, p_149633_2_, p_149633_3_,
				p_149633_4_);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_,
		...
		if (l == 2
				&& p_149695_1_.isSideSolid(p_149695_2_, p_149695_3_,
						p_149695_4_ + 1, NORTH)) {
			flag = true;
		}
		...
		if (l == 4
				&& p_149695_1_.isSideSolid(p_149695_2_ + 1, p_149695_3_,
						p_149695_4_, WEST)) {
			flag = true;
		}
